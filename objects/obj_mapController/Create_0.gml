...
if (!variable_global_exists(global.map_needs_reset)) {global.map_needs_reset = false; show_debug_message("setting maps_needs_reset to false"); }
if (!variable_global_exists(global.map_inited))     { global.map_inited = false; show_debug_message("setting map_inited to false");}
